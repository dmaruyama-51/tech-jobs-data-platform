...
from shared.pubsub_utils import MessageProcessor
from shared.logger_config import setup_logger
from functions.shared.gcs_utils import save_to_gcs, get_data_bucket_name
from shared.date_utils import get_yesterday_jst
from dotenv import load_dotenv
import os
from shared.logger_config import setup_logger
from shared.pubsub_utils import is_valid_pubsub_message
...
def scraping(request):
    ...
    try:
        ...
        try:
            ...
            processor.mark_message_as_processed(message_id, {
